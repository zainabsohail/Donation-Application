      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right" style="text-transform:uppercase">
                <li>
                    <a href="home.php"  style="font-family: 'Arvo',courier, serif ;font-size: 13px;">HOME</a>
                </li>
                <li>
...
<main role="main" >
    <div class="cbg" style="    background-color: #efefef;">
        <div class="container" >
<div class="col-md-12">
      <h2 style="text-align: center; font-family: 'Arvo',courier, serif;padding-top: 50px;">Account Log in</h2>
      <p></p>
      <div id="logbox" style="padding-top : 20px">
        ...
        <a href="home.php"><input type="submit" name="submit" value="Sign me in!" class="inputButton"  /></a>
          ...
          <h5 style="font-family: 'Arvo',courier, serif ;font-size: 13px;padding-top: 10px;"><a href="fp.php">Forgot Password?</a></h5>
          <h5 style="font-family: 'Arvo',courier, serif ;font-size: 13px;"><a href="index.php#get_involved">First Time User!</a></h5>
    </div>
        <?php
