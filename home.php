...
<main role="main">
   <div class="album py-5 bg-light" style="padding-top:5rem; padding-bottom: 4rem;">
        <div class="container">
            <div class="row"><h2 style="text-align: center; font-family: 'Arvo',courier, serif;"> Donations </h2>
...
if( isset($_GET['product_id'])!= "" )
{
    ...
    $query = mysqli_query($conn, "insert into cart(id,order_id, product_id, product_qty)values('$id','$order_id', '$pro_id',1)");
    if($query == true )
    {   
