...
<main role="main" >
    <div class="cbg" style="    background-color: #efefef;">
        <div class="container" >
        <div class="col-md-12">
      <h2 style="text-align: center; font-family: 'Arvo',courier, serif;padding-top: 50px;">Admin Log in</h2>
      <p></p>
      <div id="logbox" style="padding-top : 20px">
        <form method="post">
            <input name="email" type="text" placeholder="Admin*" required="required" class="input pass"/>
        <input name="password" type="password" placeholder="Password*" required="required" class="input pass"/>
        <a href="cms/"><input type="submit" name="submit" value="Login!" class="inputButton"/></a>
      </form>
     ...
     if(isset($_POST['submit']))
  {
    ...
    if($check>0)
        ...
        echo "<script> window.location='cms/' </script>";
        }
    else 
        {
