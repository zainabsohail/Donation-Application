...
<main role="main" >
    <div class="cbg" style="background-color: #efefef;">
        <div class="container" >
<div class="col-md-12">
    <h2 style="text-align: center; padding-top: 40px;"><i class="fa fa-user-circle fa-4x" aria-hidden="true"></i></h2>
    <h2 style="text-align: center; padding-top: 20px;">Enter Email!</h2>
      <div id="logbox" style="padding-top : 5px">
        <form method="post">
            <input name="email" type="email" placeholder="Enter your email*" required="required" class="input pass"/>
        
            <a href="index.php"><input type="submit" name="submit" value="Submit" class="inputButton"/></a>
      </form>
     ...
     if(isset($_POST['submit']))
  {
    ...
    if($check>0)
        ...
        echo "<script>alert('CHECK YOUR EMAIL TO RESET PASSWORD')</script>";
        }
    else 
        {
